        ...
        <div class="flex justify-center items-center min-h-screen flex-col relative z-10">
            ...
            <dl class="max-w-md text-white divide-y divide-gray-200 ">
                <div class="flex flex-col pb-3">
                    ...
                    <dd id="emailUserDash" class="text-lg font-semibold"><?php echo $user['email']; ?></dd>
                </div>
                <div class="flex flex-col py-3">
                    <dt class="mb-1 text-gray-400 md:text-lg ">Username</dt>
                    <dd id="usernameUserDash" class="text-lg font-semibold"><?php echo $user['username']; ?></dd>
                </div>
                    <div class="flex flex-col pt-3">
                        <dt class="mb-1 text-gray-400 md:text-lg ">Gender</dt>
                        <dd id="genderUserDash" class="text-lg font-semibold"><?php echo $user['gender']; ?></dd>
                    </div>
                <div class="flex flex-col pt-3">
                    <dt class="mb-1 text-gray-400 md:text-lg ">Faculty</dt>
                    <dd id="facultyUserDash" class="text-lg font-semibold"><?php echo $user['faculty']; ?></dd>
                </div>
                <div class="flex flex-col pt-3">
                    <dt class="mb-1 text-gray-400 md:text-lg ">Batch</dt>
                    <dd id="batchUserDash" class="text-lg font-semibold"><?php echo $user['batch']; ?></dd>
                </div>
            </dl>
